...
{
	public static BungieLocales ConvertToBungieLocale(
		this DiscordDestinyLanguageEnum discordDestinyLanguage
	)
	{
	...
	public static DestinyGameVersions ConvertToDestinyGameVersion(
		this DestinyGameVersionEnum versionEnum
	)
	{
		return versionEnum switch
		{
			...
			DestinyGameVersionEnum.FinalShape => DestinyGameVersions.TheFinalShape,
