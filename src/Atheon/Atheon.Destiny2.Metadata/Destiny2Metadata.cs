...
public static class Destiny2Metadata
{
	public static HashSet<uint> RaidCompletionMetricHashes { get; } =
		[
			...
			DefinitionHashes.Metrics.SalvationsEdgeCompletions
		];
	...
	public static ReadOnlyDictionary<uint, uint> DryStreakItemSettings { get; } =
		new(
			new Dictionary<uint, uint>
			{
				...
				{
					DefinitionHashes.Collectibles.BuriedBloodline,
					DefinitionHashes.Metrics.WarlordsRuinCompletions
				},
				{
					DefinitionHashes.Collectibles.Euphony,
					DefinitionHashes.Metrics.SalvationsEdgeCompletions
				}
			}
		);
	...
	public static ReadOnlyDictionary<uint, string> DryStreakItemSources { get; } =
		new(
			new Dictionary<uint, string>
			{
				...
				[DefinitionHashes.Collectibles.BuriedBloodline] = "Source: Warlord's Ruin Dungeon",
				[DefinitionHashes.Collectibles.Euphony] = "Source: Salvation's Edge Raid"
			}
		);
